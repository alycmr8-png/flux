...
export function TiptapNoteEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: "outline-none min-h-[420px] px-6 py-5 text-sm text-gray-900 leading-relaxed",
      },
    },
  ...
  return (
    <div className="bg-[#FFFFFF] border border-[rgba(0,0,0,0.08)] rounded-2xl overflow-hidden">
      {/* Toolbar */}
      <div className="flex items-center gap-0.5 px-4 py-2.5 border-b border-[rgba(0,0,0,0.07)] flex-wrap">
