...
export function TiptapNoteEditor({
    ...
    return (
      <button
        ...
        className={`px-2 py-1 rounded text-xs font-medium transition-colors ${
          active ? "bg-indigo-600 text-white" : "text-slate-400 hover:text-slate-100 hover:bg-[rgba(148,163,184,0.14)]"
        }`}
      >
        {children}
      </button>
  ...
  return (
    <div className="bg-[#1A2030] border border-[rgba(148,163,184,0.2)] rounded-2xl overflow-hidden">
      {/* Toolbar */}
      <div className="flex items-center gap-0.5 px-4 py-2.5 border-b border-[rgba(148,163,184,0.16)] flex-wrap">
