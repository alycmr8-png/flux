    ...
    <div className="space-y-4">
      <div className="rounded-2xl p-6 text-center" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>Recording Psychology 301…</span>
        </div>
      </div>
      <div className="rounded-2xl p-4" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="text-[10px] uppercase tracking-widest mb-2" style={{ color: "rgba(255,255,255,0.35)" }}>Previous recordings</div>
        {["Week 3 - Memory & Cognition", "Week 2 - Behavioral Theory", "Week 1 - Introduction"].map((title, i) => (
          <div key={i} className="flex items-center justify-between py-2 border-b last:border-0" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
            <span className="text-sm" style={{ color: "white" }}>{title}</span>
            <span className="text-xs" style={{ color: "rgba(255,255,255,0.35)" }}>AI ready</span>
          </div>
        ))}
      </div>
    </div>
        ...
        {vtab === "chatbot" && (
          <div className="space-y-3">
            <div className="flex justify-end">
              <div className="px-4 py-2.5 rounded-2xl rounded-tr-sm text-sm max-w-[80%]" style={{ background: "white", color: "#111110" }}>
                What's the difference between structuralism and functionalism?
              </div>
            </div>
            <div className="flex justify-start">
              <div className="px-4 py-2.5 rounded-2xl rounded-tl-sm text-sm max-w-[85%] leading-relaxed" style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.75)", border: "1px solid rgba(255,255,255,0.1)" }}>
    ...
    <section className="px-6 md:px-16 py-16 md:py-24" style={{ background: "#0a0a0a" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center mb-8 overflow-x-auto">
          <div className="flex gap-1 p-1 rounded-2xl shrink-0" style={{ background: "rgba(255,255,255,0.08)" }}>
            {TABS.map(({ key, label, icon: Icon }) => (
              <button key={key} onClick={() => setActive(key)}
                ...
                style={{
                  ...
                  color: active === key ? "#111110" : "rgba(255,255,255,0.45)",
                  boxShadow: active === key ? "0 1px 4px rgba(0,0,0,0.3)" : "none",
                }}>
                <Icon size={13} />
                {label}
              </button>
