...
const FAQS = [
  ...
  { q: "How long can a recording be?", a: "Up to 3 hours per recording on paid plans, and 60 minutes on Free — enough for any lecture. When you reach the limit, Ucorns pauses and lets you process what you've recorded." },
