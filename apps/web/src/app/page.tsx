...
export default async function LandingPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col" style={{ background: "#111110" }}>
      ...
      {/* Hero */}
      <div className="flex flex-col items-center text-center px-16 pt-48 pb-12">
        ...
        <h1 className="italic text-6xl text-white mb-5 leading-tight" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 400 }}>
          Your 24/7<br />AI study team.
        </h1>
        <p className="text-base mb-10 leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
          You record the lecture. You get flashcards, quizzes,<br />
          practice tests, and more — built from exactly<br />
      ...
      <div className="flex justify-center px-12 pb-20">
        <RecordingDemo />
      </div>
      ...
      <div className="px-16 py-20 flex flex-col gap-16">
        ...
        <div className="flex items-stretch gap-12">
          <div className="relative w-[240px] h-[300px] shrink-0">
            <Image
              src="/usman.jpeg"
              alt="Usman Tariq"
              fill
          ...
          <div className="flex flex-col justify-center max-w-sm">
            ...
            <p className="text-xl leading-relaxed mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontWeight: 400, color: "white" }}>
        ...
        {/* Testimonial 2 — Sira */}
        <div className="flex items-stretch gap-12 flex-row-reverse">
          <div className="relative w-[240px] h-[340px] shrink-0">
            <Image
              src="/sira.png"
              alt="Sira Camara"
              fill
          ...
          <div className="flex flex-col justify-center max-w-sm ml-auto">
            <div className="text-5xl mb-4" style={{ color: "rgba(255,255,255,0.15)", fontFamily: "Georgia, serif", lineHeight: 1 }}>"</div>
            <p className="text-xl leading-relaxed mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontWeight: 400, color: "white" }}>
